  ...
  return (
    <section id="contact" className="py-20 lg:py-28 bg-cream-200/50">
      <div className="section-pad max-w-7xl mx-auto">
        <div className="relative overflow-hidden rounded-3xl bg-rust-500 px-7 py-12 sm:px-12 lg:px-16 lg:py-16 shadow-rust-glow">
          ...
          <div className="relative grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8">
              ...
              <div className="mt-6 flex items-center gap-3">
                <a
                  ...
                  rel="noreferrer"
                  aria-label="GitHub"
                  className="grid place-items-center h-10 w-10 rounded-xl bg-white/15 hover:bg-white/25 text-white transition-colors"
                >
                  <Github size={18} />
                </a>
                <a
            ...
            <div className="lg:col-span-4 flex lg:justify-end">
              <a
                href="mailto:rithikarajar@gmail.com"
                className="group inline-flex items-center gap-2.5 rounded-xl bg-white hover:bg-cream-100 text-rust-600 font-semibold px-7 py-4 transition-all hover:shadow-lg"
              >
                Get In Touch
